...
export interface WithdrawalHandlerInterface extends utils.Interface {
  functions: {
    "_executeWithdrawal(bytes32,(uint256,address[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],bytes[],address[]),address,uint256)": FunctionFragment;
    "cancelWithdrawal(bytes32)": FunctionFragment;
    "createWithdrawal(address,(address,address,address,address[],address[],uint256,uint256,uint256,bool,uint256,uint256))": FunctionFragment;
