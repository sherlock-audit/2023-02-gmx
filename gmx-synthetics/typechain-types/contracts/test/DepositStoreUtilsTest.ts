...
export interface DepositStoreUtilsTestInterface extends utils.Interface {
  functions: {
    ...
    "setDeposit(address,bytes32,((address,address,address,address,address,address,address[],address[]),(uint256,uint256,uint256,uint256,uint256,uint256),(bool)))": FunctionFragment;
  };
