...
export interface IOrderCallbackReceiverInterface extends utils.Interface {
  functions: {
    "afterOrderCancellation(bytes32,((address,address,address,address,address,address[]),(uint8,uint8,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool,bool,bool)))": FunctionFragment;
    "afterOrderExecution(bytes32,((address,address,address,address,address,address[]),(uint8,uint8,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool,bool,bool)))": FunctionFragment;
    "afterOrderFrozen(bytes32,((address,address,address,address,address,address[]),(uint8,uint8,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool,bool,bool)))": FunctionFragment;
  };
