...
export interface CallbackUtilsInterface extends utils.Interface {
  ...
  events: {
    "AfterDepositCancellationError(bytes32,tuple,string,bytes)": EventFragment;
    "AfterDepositExecutionError(bytes32,tuple,string,bytes)": EventFragment;
    "AfterOrderCancellationError(bytes32,tuple,string,bytes)": EventFragment;
    "AfterOrderExecutionError(bytes32,tuple,string,bytes)": EventFragment;
    "AfterOrderFrozenError(bytes32,tuple,string,bytes)": EventFragment;
    "AfterWithdrawalCancellationError(bytes32,tuple,string,bytes)": EventFragment;
    "AfterWithdrawalExecutionError(bytes32,tuple,string,bytes)": EventFragment;
  };
...
export type AfterDepositCancellationErrorEvent = TypedEvent<
  [string, Deposit.PropsStructOutput, string, string],
...
export type AfterOrderCancellationErrorEvent = TypedEvent<
  [string, Order.PropsStructOutput, string, string],
...
export type AfterWithdrawalCancellationErrorEvent = TypedEvent<
  [string, Withdrawal.PropsStructOutput, string, string],
...
export interface CallbackUtils extends BaseContract {
  ...
  filters: {
    "AfterDepositCancellationError(bytes32,tuple,string,bytes)"(
      key?: null,
      deposit?: null,
      reason?: null,
      reasonBytes?: null
    ...
    "AfterDepositExecutionError(bytes32,tuple,string,bytes)"(
      key?: null,
      deposit?: null,
      reason?: null,
      reasonBytes?: null
    ...
    "AfterOrderCancellationError(bytes32,tuple,string,bytes)"(
      key?: null,
      order?: null,
      reason?: null,
      reasonBytes?: null
    ...
    "AfterOrderExecutionError(bytes32,tuple,string,bytes)"(
      key?: null,
      order?: null,
      reason?: null,
      reasonBytes?: null
    ...
    "AfterOrderFrozenError(bytes32,tuple,string,bytes)"(
      key?: null,
      order?: null,
      reason?: null,
      reasonBytes?: null
    ...
    "AfterWithdrawalCancellationError(bytes32,tuple,string,bytes)"(
      key?: null,
      withdrawal?: null,
      reason?: null,
      reasonBytes?: null
    ...
    "AfterWithdrawalExecutionError(bytes32,tuple,string,bytes)"(
      key?: null,
      withdrawal?: null,
      reason?: null,
      reasonBytes?: null
