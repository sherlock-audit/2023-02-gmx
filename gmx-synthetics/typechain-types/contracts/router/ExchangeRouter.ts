...
export declare namespace OracleUtils {
  export type SimulatePricesParamsStruct = {
    ...
    secondaryTokens: PromiseOrValue<string>[];
    secondaryPrices: Price.PropsStruct[];
  };
  ...
  export type SimulatePricesParamsStructOutput = [
    ...
    secondaryPrices: Price.PropsStructOutput[];
  };
}
...
export interface ExchangeRouterInterface extends utils.Interface {
  functions: {
    ...
    "createDeposit((address,address,address,address,address,address[],address[],uint256,bool,uint256,uint256))": FunctionFragment;
    "createOrder(((address,address,address,address,address[]),(uint256,uint256,uint256,uint256,uint256,uint256,uint256),uint8,uint8,bool,bool,bytes32))": FunctionFragment;
    "createWithdrawal((address,address,address,address[],address[],uint256,uint256,uint256,bool,uint256,uint256))": FunctionFragment;
    ...
    "simulateExecuteDeposit(bytes32,(address[],(uint256,uint256)[],address[],(uint256,uint256)[]))": FunctionFragment;
    "simulateExecuteOrder(bytes32,(address[],(uint256,uint256)[],address[],(uint256,uint256)[]))": FunctionFragment;
    "simulateExecuteWithdrawal(bytes32,(address[],(uint256,uint256)[],address[],(uint256,uint256)[]))": FunctionFragment;
